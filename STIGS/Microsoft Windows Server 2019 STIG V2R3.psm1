...
Microsoft Windows Server 2019 Security Technical Implementation Guide :: Version 2, Release: 3 Benchmark Date: 01 Nov 2021
...
Function SV-205657r793212_rule {
...
Function SV-205728r793217_rule {
...
Function SV-205803r793216_rule {
    if($Global:installedprograms.displayname -contains "McAfee Agent"){
        return [pscustomobject]@{Status='NotAFinding';Comment='';Finding_Details=''}
        }
    }
...
Function SV-205851r793214_rule {
...
Function SV-205907r793209_rule {
    if($Global:ServerRole -eq 2){
        return [pscustomobject]@{Status='Not_Applicable';Comment='';Finding_Details=''}
        }
    else{

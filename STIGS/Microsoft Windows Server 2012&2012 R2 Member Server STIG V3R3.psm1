...
Microsoft Windows Server 2012/2012 R2 Member Server Security Technical Implementation Guide :: Version 3, Release: 3 Benchmark Date: 01 Nov 2021
#>
...
Function SV-225243r793246_rule {
...
Function SV-225434r793248_rule {
    if($Global:installedprograms.displayname -contains "McAfee Agent") {
        return [pscustomobject]@{Status='NotAFinding';Comment='';Finding_Details=''}
        }
    }
